<template>
  <div class="form-signin w-100 m-auto">
    <Form @submit="onSubmit">
      ...
      >
        <LoaderComp class="spin" v-if="getRegisterUser.loading" />
  ...
  <div
    v-if="!!getRegisterUser.error"
    class="form-alert alert alert-danger position-absolute m-0"
    role="alert"
  >
